 ...
 *
 * public function __construct($input = null, $flags = 0, $iterator_class = "ArrayIterator") { }
 * public function offsetExists($index) { }返回请求的索引是否存在
 * public function offsetGet($index) { }返回指定索引处的值
 * public function offsetSet($index, $newval) { }设定指定索引处的值
 * public function offsetUnset($index) { }清空指定索引处的值
 * public function append($value) { } 在末尾添加一个元素
 * public function getArrayCopy() { } 创建ArrayObject的副本
 * public function count() { } 返回数量
 * public function getFlags() { }
 * public function setFlags($flags) { }
 *
 * public function asort() { }安值排序
 * public function ksort() { }安键值排序
 * public function uasort($cmp_function) { }
 * public function uksort($cmp_function) { }
 *
 * public function natsort() { } 用“自然排序”算法排序项
 * public function natcasesort() { } 使用的是不区分大小写的“自然排序”算法对数组进行排序
 * public function unserialize($serialized) { } 反序列化
 * public function serialize() { }序列化
