    ...
    e.widget("ui.autocomplete", {options: {minLength: 1, delay: 300}, _create: function () {
        ...
        destroy: function () {
            ...
            if (this.menu.element.is(":visible"))if (this.menu.first() && /^previous/.test(a) || this.menu.last() && /^next/.test(a)) {
                ...
                this.menu.deactivate()
            } else this.menu[a](c); else this.search(null, c)
        }, widget: function () {
...
(function (e) {
    e.widget("ui.menu", {_create: function () {
        ...
        if (this.hasScroll()) {
            ...
            if (d < 0)this.element.attr("scrollTop", b + d); else d > f && this.element.attr("scrollTop", b + d - f + c.height())
        }
        ...
        _mouseDrag: function (a) {
            ...
            if (this.options.values && this.options.values.length)this.handles.each(function (l) {
                ...
                if (c.options.range === true)if (c.orientation === "horizontal") {
                    if (l === 0)c.range.stop(1, 1)[e ? "animate" : "css"]({left: f + "%"}, b.animate);
                    if (l === 1)c.range[e ? "animate" : "css"]({width: f -
                        h + "%"}, {queue: false, duration: b.animate})
                } else {
                    if (l === 0)c.range.stop(1, 1)[e ? "animate" : "css"]({bottom: f + "%"}, b.animate);
                    if (l === 1)c.range[e ? "animate" : "css"]({height: f - h + "%"}, {queue: false, duration: b.animate})
                }
                h = f
            }); else {
                i = this.value();
